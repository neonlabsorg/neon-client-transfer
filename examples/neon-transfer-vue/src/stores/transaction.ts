...
export const useTransactionStore = defineStore('transaction', {
    ...
    actions: {
        ...
        async sendTransaction(transaction: SolanaTransaction) {
            ...
            const { blockhash, lastValidBlockHeight } = await web3Store.solanaConnection.getLatestBlockhash();
            await web3Store.solanaConnection.confirmTransaction({ blockhash, lastValidBlockHeight, signature });
