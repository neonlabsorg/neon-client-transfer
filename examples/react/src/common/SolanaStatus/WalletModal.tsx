    ...
    return (
        ...
        createPortal(
            <div
                ...
                role="dialog"
            >
                <div className="modal z-10 max-w-420px">
                    <div className={`px-6 pb-6 ${!logo && 'wallet-adapter-modal-wrapper-no-logo'}`}>
                        {logo && (
                        ...
                        <h1 className="modal__title mb-6" id="-modal-title">
                            Connect Wallet
                        </h1>
                        ...
                        <ul className="w-full flex flex-col">
                            {featured.map((wallet) => (
                                <WalletListItem
                                    key={wallet.name}
                                    handleClick={(event: React.MouseEvent<Element, globalThis.MouseEvent>) => handleWalletClick(event, wallet.name)}
                                    wallet={wallet}
                                />
                            ))}
                        </ul>
