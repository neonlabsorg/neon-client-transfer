...
function erc20ForSPLContract(proxyUrl) {
    return new web3_eth_contract_1.Contract(core_1.erc20Abi, new web3_core_1.Web3Context(proxyUrl));
}
exports.erc20ForSPLContract = erc20ForSPLContract;
function neonWrapperContract(proxyUrl) {
    return new web3_eth_contract_1.Contract(core_1.neonWrapperAbi, new web3_core_1.Web3Context(proxyUrl));
}
exports.neonWrapperContract = neonWrapperContract;
function neonWrapper2Contract(proxyUrl, address) {
    return new web3_eth_contract_1.Contract(core_1.neonWrapper2Abi, address, new web3_core_1.Web3Context(proxyUrl));
}
