...
function neonTransferMintTransactionWeb3(connection, proxyUrl, proxyApi, proxyStatus, neonEvmProgram, solanaWallet, neonWallet, walletSigner, splToken, amount, chainId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const climeData = (0, utils_2.claimTransactionData)(proxyUrl, associatedTokenAddress, neonWallet, fullAmount);
        const signedTransaction = yield (0, utils_2.neonClaimTransactionFromSigner)(climeData, walletSigner, neonWallet, splToken, proxyUrl);
...
function createMintNeonTransactionWeb3(proxyUrl, neonWallet, associatedToken, splToken, amount, gasLimit = 5e4) {
    return __awaiter(this, void 0, void 0, function* () {
        const data = (0, utils_2.mintNeonTransactionData)(proxyUrl, associatedToken, splToken, amount);
        const transaction = (0, core_1.createMintNeonTransaction)(neonWallet, splToken, data);
        const { gasPrice, gas } = yield (0, utils_2.getGasAndEstimationGasPrice)(proxyUrl, transaction);
        ...
        transaction['gasLimit'] = (0, utils_2.getGasLimit)(transaction.gas, BigInt(gasLimit));
        return transaction;
    });
}
