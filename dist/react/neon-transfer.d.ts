...
export declare function useNeonTransfer(events: InstructionEvents, connection: Connection, web3: Web3, publicKey: PublicKey, neonWalletAddress: string): {
    deposit: (amount: number, splToken: SPLToken) => any;
    withdraw: (amount: number, splToken: SPLToken) => any;
