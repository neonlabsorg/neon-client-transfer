...
import { createNeonDepositInstruction, createNeonTransferInstruction, neonTransactionDataWeb3, solanaNEONTransferTransaction } from '../neon-transfer';
...
export class NeonPortal extends InstructionService {
    ...
    neonTransferTransaction(amount, token, serviceWallet, rewardAmount) {
        return __awaiter(this, void 0, void 0, function* () {
            const transaction = yield solanaNEONTransferTransaction(this.solanaWalletPubkey, this.neonWalletAddress, this.programId, this.tokenMint, token, amount, 111, serviceWallet, rewardAmount);
