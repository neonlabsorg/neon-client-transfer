...
export function itSolanaTokenSPL(connection: Connection, web3: Web3, neonProxyRpcApi: NeonProxyRpcApi, neonProxyStatus: NeonProgramStatus, token: SPLToken, neonEvmProgram: PublicKey, solanaWallet: Keypair, neonWallet: Account, chainId: number, solanaUrl: string, skipPreflight = false): void {
...
export function itNeonTokenMint(connection: Connection, web3: Web3, faucet: FaucetDropper, token: SPLToken, neonProxyStatus: NeonProgramStatus, solanaWallet: Keypair, neonWallet: Account, solanaUrl: string, skipPreflight = false): void {
